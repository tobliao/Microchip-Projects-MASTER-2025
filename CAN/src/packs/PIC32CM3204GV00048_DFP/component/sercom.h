...
#ifndef _PIC32CMGV00_SERCOM_COMPONENT_H_
#define _PIC32CMGV00_SERCOM_COMPONENT_H_
...
#define SERCOM_I2CM_CTRLA_LOWTOUT_Pos         _UINT32_(30)                                         /* (SERCOM_I2CM_CTRLA) SCL Low Time-out Position */
#define SERCOM_I2CM_CTRLA_LOWTOUT_Msk         (_UINT32_(0x1) << SERCOM_I2CM_CTRLA_LOWTOUT_Pos)     /* (SERCOM_I2CM_CTRLA) SCL Low Time-out Mask */
#define SERCOM_I2CM_CTRLA_LOWTOUT(value)      (SERCOM_I2CM_CTRLA_LOWTOUT_Msk & (_UINT32_(value) << SERCOM_I2CM_CTRLA_LOWTOUT_Pos)) /* Assignment of value for LOWTOUT in the SERCOM_I2CM_CTRLA register */
#define SERCOM_I2CM_CTRLA_Msk                 _UINT32_(0x7031009F)                                 /* (SERCOM_I2CM_CTRLA) Register Mask  */
...
#define SERCOM_I2CS_CTRLA_LOWTOUT_Pos         _UINT32_(30)                                         /* (SERCOM_I2CS_CTRLA) SCL Low Time-out Position */
#define SERCOM_I2CS_CTRLA_LOWTOUT_Msk         (_UINT32_(0x1) << SERCOM_I2CS_CTRLA_LOWTOUT_Pos)     /* (SERCOM_I2CS_CTRLA) SCL Low Time-out Mask */
#define SERCOM_I2CS_CTRLA_LOWTOUT(value)      (SERCOM_I2CS_CTRLA_LOWTOUT_Msk & (_UINT32_(value) << SERCOM_I2CS_CTRLA_LOWTOUT_Pos)) /* Assignment of value for LOWTOUT in the SERCOM_I2CS_CTRLA register */
#define SERCOM_I2CS_CTRLA_Msk                 _UINT32_(0x4031009F)                                 /* (SERCOM_I2CS_CTRLA) Register Mask  */
...
#define SERCOM_SPIM_CTRLA_RUNSTDBY_Pos        _UINT32_(7)                                          /* (SERCOM_SPIM_CTRLA) Run In Standby Position */
#define SERCOM_SPIM_CTRLA_RUNSTDBY_Msk        (_UINT32_(0x1) << SERCOM_SPIM_CTRLA_RUNSTDBY_Pos)    /* (SERCOM_SPIM_CTRLA) Run In Standby Mask */
...
#define SERCOM_SPIS_CTRLA_RUNSTDBY_Pos        _UINT32_(7)                                          /* (SERCOM_SPIS_CTRLA) Run In Standby Position */
#define SERCOM_SPIS_CTRLA_RUNSTDBY_Msk        (_UINT32_(0x1) << SERCOM_SPIS_CTRLA_RUNSTDBY_Pos)    /* (SERCOM_SPIS_CTRLA) Run In Standby Mask */
...
#define SERCOM_USART_EXT_CTRLA_RUNSTDBY_Pos   _UINT32_(7)                                          /* (SERCOM_USART_EXT_CTRLA) Run In Standby Position */
#define SERCOM_USART_EXT_CTRLA_RUNSTDBY_Msk   (_UINT32_(0x1) << SERCOM_USART_EXT_CTRLA_RUNSTDBY_Pos) /* (SERCOM_USART_EXT_CTRLA) Run In Standby Mask */
...
#define SERCOM_USART_EXT_CTRLA_TXPO_Msk       (_UINT32_(0x1) << SERCOM_USART_EXT_CTRLA_TXPO_Pos)   /* (SERCOM_USART_EXT_CTRLA) Transmit Data Pinout Mask */
...
#define SERCOM_USART_EXT_CTRLA_Msk            _UINT32_(0x7F31019F)                                 /* (SERCOM_USART_EXT_CTRLA) Register Mask  */
...
#define SERCOM_USART_INT_CTRLA_RUNSTDBY_Pos   _UINT32_(7)                                          /* (SERCOM_USART_INT_CTRLA) Run In Standby Position */
#define SERCOM_USART_INT_CTRLA_RUNSTDBY_Msk   (_UINT32_(0x1) << SERCOM_USART_INT_CTRLA_RUNSTDBY_Pos) /* (SERCOM_USART_INT_CTRLA) Run In Standby Mask */
...
#define SERCOM_USART_INT_CTRLA_TXPO_Msk       (_UINT32_(0x1) << SERCOM_USART_INT_CTRLA_TXPO_Pos)   /* (SERCOM_USART_INT_CTRLA) Transmit Data Pinout Mask */
...
#define SERCOM_USART_INT_CTRLA_Msk            _UINT32_(0x7F31019F)                                 /* (SERCOM_USART_INT_CTRLA) Register Mask  */
...
#define SERCOM_I2CS_CTRLB_Msk                 _UINT32_(0x0007C100)                                 /* (SERCOM_I2CS_CTRLB) Register Mask  */
...
#define SERCOM_SPIM_CTRLB_PLOADEN_Pos         _UINT32_(6)                                          /* (SERCOM_SPIM_CTRLB) Slave Data Preload Enable Position */
#define SERCOM_SPIM_CTRLB_PLOADEN_Msk         (_UINT32_(0x1) << SERCOM_SPIM_CTRLB_PLOADEN_Pos)     /* (SERCOM_SPIM_CTRLB) Slave Data Preload Enable Mask */
...
#define   SERCOM_SPIM_CTRLB_AMODE_MASK_Val    _UINT32_(0x0)                                        /* (SERCOM_SPIM_CTRLB) ADDRMASK is used as a mask to the ADDR register.  */
#define   SERCOM_SPIM_CTRLB_AMODE_2_ADDRESSES_Val _UINT32_(0x1)                                        /* (SERCOM_SPIM_CTRLB) The slave responds to the 2 unique addresses in ADDR and ADDRMASK.  */
...
#define SERCOM_SPIM_CTRLB_Msk                 _UINT32_(0x0002C047)                                 /* (SERCOM_SPIM_CTRLB) Register Mask  */
...
#define SERCOM_SPIS_CTRLB_PLOADEN_Pos         _UINT32_(6)                                          /* (SERCOM_SPIS_CTRLB) Slave Data Preload Enable Position */
#define SERCOM_SPIS_CTRLB_PLOADEN_Msk         (_UINT32_(0x1) << SERCOM_SPIS_CTRLB_PLOADEN_Pos)     /* (SERCOM_SPIS_CTRLB) Slave Data Preload Enable Mask */
...
#define   SERCOM_SPIS_CTRLB_AMODE_MASK_Val    _UINT32_(0x0)                                        /* (SERCOM_SPIS_CTRLB) ADDRMASK is used as a mask to the ADDR register.  */
#define   SERCOM_SPIS_CTRLB_AMODE_2_ADDRESSES_Val _UINT32_(0x1)                                        /* (SERCOM_SPIS_CTRLB) The slave responds to the 2 unique addresses in ADDR and ADDRMASK.  */
...
#define SERCOM_SPIS_CTRLB_Msk                 _UINT32_(0x0002C047)                                 /* (SERCOM_SPIS_CTRLB) Register Mask  */
...
#define SERCOM_USART_EXT_CTRLB_Msk            _UINT32_(0x00032247)                                 /* (SERCOM_USART_EXT_CTRLB) Register Mask  */
...
#define SERCOM_USART_INT_CTRLB_Msk            _UINT32_(0x00032247)                                 /* (SERCOM_USART_INT_CTRLB) Register Mask  */
...
#define SERCOM_SPIM_DBGCTRL_DBGSTOP_Pos       _UINT8_(0)                                           /* (SERCOM_SPIM_DBGCTRL) Debug Stop Mode Position */
#define SERCOM_SPIM_DBGCTRL_DBGSTOP_Msk       (_UINT8_(0x1) << SERCOM_SPIM_DBGCTRL_DBGSTOP_Pos)    /* (SERCOM_SPIM_DBGCTRL) Debug Stop Mode Mask */
...
#define SERCOM_SPIS_DBGCTRL_DBGSTOP_Pos       _UINT8_(0)                                           /* (SERCOM_SPIS_DBGCTRL) Debug Stop Mode Position */
#define SERCOM_SPIS_DBGCTRL_DBGSTOP_Msk       (_UINT8_(0x1) << SERCOM_SPIS_DBGCTRL_DBGSTOP_Pos)    /* (SERCOM_SPIS_DBGCTRL) Debug Stop Mode Mask */
...
#define SERCOM_USART_EXT_DBGCTRL_DBGSTOP_Pos  _UINT8_(0)                                           /* (SERCOM_USART_EXT_DBGCTRL) Debug Stop Mode Position */
#define SERCOM_USART_EXT_DBGCTRL_DBGSTOP_Msk  (_UINT8_(0x1) << SERCOM_USART_EXT_DBGCTRL_DBGSTOP_Pos) /* (SERCOM_USART_EXT_DBGCTRL) Debug Stop Mode Mask */
...
#define SERCOM_USART_INT_DBGCTRL_DBGSTOP_Pos  _UINT8_(0)                                           /* (SERCOM_USART_INT_DBGCTRL) Debug Stop Mode Position */
#define SERCOM_USART_INT_DBGCTRL_DBGSTOP_Msk  (_UINT8_(0x1) << SERCOM_USART_INT_DBGCTRL_DBGSTOP_Pos) /* (SERCOM_USART_INT_DBGCTRL) Debug Stop Mode Mask */
...
#define SERCOM_I2CM_BAUD_RESETVALUE           _UINT16_(0x00)                                       /*  (SERCOM_I2CM_BAUD) I2CM Baud Rate  Reset Value */

#define SERCOM_I2CM_BAUD_BAUD_Pos             _UINT16_(0)                                          /* (SERCOM_I2CM_BAUD) Master Baud Rate Position */
#define SERCOM_I2CM_BAUD_BAUD_Msk             (_UINT16_(0xFF) << SERCOM_I2CM_BAUD_BAUD_Pos)        /* (SERCOM_I2CM_BAUD) Master Baud Rate Mask */
#define SERCOM_I2CM_BAUD_BAUD(value)          (SERCOM_I2CM_BAUD_BAUD_Msk & (_UINT16_(value) << SERCOM_I2CM_BAUD_BAUD_Pos)) /* Assignment of value for BAUD in the SERCOM_I2CM_BAUD register */
#define SERCOM_I2CM_BAUD_BAUDLOW_Pos          _UINT16_(8)                                          /* (SERCOM_I2CM_BAUD) Master Baud Rate Low Position */
#define SERCOM_I2CM_BAUD_BAUDLOW_Msk          (_UINT16_(0xFF) << SERCOM_I2CM_BAUD_BAUDLOW_Pos)     /* (SERCOM_I2CM_BAUD) Master Baud Rate Low Mask */
#define SERCOM_I2CM_BAUD_BAUDLOW(value)       (SERCOM_I2CM_BAUD_BAUDLOW_Msk & (_UINT16_(value) << SERCOM_I2CM_BAUD_BAUDLOW_Pos)) /* Assignment of value for BAUDLOW in the SERCOM_I2CM_BAUD register */
#define SERCOM_I2CM_BAUD_Msk                  _UINT16_(0xFFFF)                                     /* (SERCOM_I2CM_BAUD) Register Mask  */
...
#define SERCOM_SPIM_BAUD_BAUD_Pos             _UINT8_(0)                                           /* (SERCOM_SPIM_BAUD) Baud Register Position */
#define SERCOM_SPIM_BAUD_BAUD_Msk             (_UINT8_(0xFF) << SERCOM_SPIM_BAUD_BAUD_Pos)         /* (SERCOM_SPIM_BAUD) Baud Register Mask */
...
#define SERCOM_SPIS_BAUD_BAUD_Pos             _UINT8_(0)                                           /* (SERCOM_SPIS_BAUD) Baud Register Position */
#define SERCOM_SPIS_BAUD_BAUD_Msk             (_UINT8_(0xFF) << SERCOM_SPIS_BAUD_BAUD_Pos)         /* (SERCOM_SPIS_BAUD) Baud Register Mask */
...
#define SERCOM_USART_EXT_BAUD_RESETVALUE      _UINT16_(0x00)                                       /*  (SERCOM_USART_EXT_BAUD) USART_EXT Baud  Reset Value */

#define SERCOM_USART_EXT_BAUD_BAUD_Pos        _UINT16_(0)                                          /* (SERCOM_USART_EXT_BAUD) Baud Value Position */
#define SERCOM_USART_EXT_BAUD_BAUD_Msk        (_UINT16_(0xFFFF) << SERCOM_USART_EXT_BAUD_BAUD_Pos) /* (SERCOM_USART_EXT_BAUD) Baud Value Mask */
...
#define SERCOM_USART_INT_BAUD_RESETVALUE      _UINT16_(0x00)                                       /*  (SERCOM_USART_INT_BAUD) USART_INT Baud  Reset Value */

#define SERCOM_USART_INT_BAUD_BAUD_Pos        _UINT16_(0)                                          /* (SERCOM_USART_INT_BAUD) Baud Value Position */
#define SERCOM_USART_INT_BAUD_BAUD_Msk        (_UINT16_(0xFFFF) << SERCOM_USART_INT_BAUD_BAUD_Pos) /* (SERCOM_USART_INT_BAUD) Baud Value Mask */
...
#define SERCOM_I2CM_INTENCLR_MB_Pos           _UINT8_(0)                                           /* (SERCOM_I2CM_INTENCLR) Master on Bus Interrupt Enable Position */
#define SERCOM_I2CM_INTENCLR_MB_Msk           (_UINT8_(0x1) << SERCOM_I2CM_INTENCLR_MB_Pos)        /* (SERCOM_I2CM_INTENCLR) Master on Bus Interrupt Enable Mask */
...
#define SERCOM_I2CM_INTENCLR_SB_Pos           _UINT8_(1)                                           /* (SERCOM_I2CM_INTENCLR) Slave on Bus Interrupt Enable Position */
#define SERCOM_I2CM_INTENCLR_SB_Msk           (_UINT8_(0x1) << SERCOM_I2CM_INTENCLR_SB_Pos)        /* (SERCOM_I2CM_INTENCLR) Slave on Bus Interrupt Enable Mask */
...
#define SERCOM_I2CM_INTENCLR_Msk              _UINT8_(0x03)                                        /* (SERCOM_I2CM_INTENCLR) Register Mask  */
...
#define SERCOM_I2CS_INTENCLR_Msk              _UINT8_(0x07)                                        /* (SERCOM_I2CS_INTENCLR) Register Mask  */
...
#define SERCOM_SPIM_INTENCLR_DRE_Pos          _UINT8_(0)                                           /* (SERCOM_SPIM_INTENCLR) Data Register Empty Interrupt Enable Position */
#define SERCOM_SPIM_INTENCLR_DRE_Msk          (_UINT8_(0x1) << SERCOM_SPIM_INTENCLR_DRE_Pos)       /* (SERCOM_SPIM_INTENCLR) Data Register Empty Interrupt Enable Mask */
...
#define SERCOM_SPIM_INTENCLR_TXC_Pos          _UINT8_(1)                                           /* (SERCOM_SPIM_INTENCLR) Transmit Complete Interrupt Enable Position */
#define SERCOM_SPIM_INTENCLR_TXC_Msk          (_UINT8_(0x1) << SERCOM_SPIM_INTENCLR_TXC_Pos)       /* (SERCOM_SPIM_INTENCLR) Transmit Complete Interrupt Enable Mask */
...
#define SERCOM_SPIM_INTENCLR_RXC_Pos          _UINT8_(2)                                           /* (SERCOM_SPIM_INTENCLR) Receive Complete Interrupt Enable Position */
#define SERCOM_SPIM_INTENCLR_RXC_Msk          (_UINT8_(0x1) << SERCOM_SPIM_INTENCLR_RXC_Pos)       /* (SERCOM_SPIM_INTENCLR) Receive Complete Interrupt Enable Mask */
...
#define SERCOM_SPIM_INTENCLR_Msk              _UINT8_(0x07)                                        /* (SERCOM_SPIM_INTENCLR) Register Mask  */
...
#define SERCOM_SPIS_INTENCLR_DRE_Pos          _UINT8_(0)                                           /* (SERCOM_SPIS_INTENCLR) Data Register Empty Interrupt Enable Position */
#define SERCOM_SPIS_INTENCLR_DRE_Msk          (_UINT8_(0x1) << SERCOM_SPIS_INTENCLR_DRE_Pos)       /* (SERCOM_SPIS_INTENCLR) Data Register Empty Interrupt Enable Mask */
...
#define SERCOM_SPIS_INTENCLR_TXC_Pos          _UINT8_(1)                                           /* (SERCOM_SPIS_INTENCLR) Transmit Complete Interrupt Enable Position */
#define SERCOM_SPIS_INTENCLR_TXC_Msk          (_UINT8_(0x1) << SERCOM_SPIS_INTENCLR_TXC_Pos)       /* (SERCOM_SPIS_INTENCLR) Transmit Complete Interrupt Enable Mask */
...
#define SERCOM_SPIS_INTENCLR_RXC_Pos          _UINT8_(2)                                           /* (SERCOM_SPIS_INTENCLR) Receive Complete Interrupt Enable Position */
#define SERCOM_SPIS_INTENCLR_RXC_Msk          (_UINT8_(0x1) << SERCOM_SPIS_INTENCLR_RXC_Pos)       /* (SERCOM_SPIS_INTENCLR) Receive Complete Interrupt Enable Mask */
...
#define SERCOM_SPIS_INTENCLR_Msk              _UINT8_(0x07)                                        /* (SERCOM_SPIS_INTENCLR) Register Mask  */
...
#define SERCOM_USART_EXT_INTENCLR_DRE_Pos     _UINT8_(0)                                           /* (SERCOM_USART_EXT_INTENCLR) Data Register Empty Interrupt Enable Position */
#define SERCOM_USART_EXT_INTENCLR_DRE_Msk     (_UINT8_(0x1) << SERCOM_USART_EXT_INTENCLR_DRE_Pos)  /* (SERCOM_USART_EXT_INTENCLR) Data Register Empty Interrupt Enable Mask */
...
#define SERCOM_USART_EXT_INTENCLR_TXC_Pos     _UINT8_(1)                                           /* (SERCOM_USART_EXT_INTENCLR) Transmit Complete Interrupt Enable Position */
#define SERCOM_USART_EXT_INTENCLR_TXC_Msk     (_UINT8_(0x1) << SERCOM_USART_EXT_INTENCLR_TXC_Pos)  /* (SERCOM_USART_EXT_INTENCLR) Transmit Complete Interrupt Enable Mask */
...
#define SERCOM_USART_EXT_INTENCLR_RXC_Pos     _UINT8_(2)                                           /* (SERCOM_USART_EXT_INTENCLR) Receive Complete Interrupt Enable Position */
#define SERCOM_USART_EXT_INTENCLR_RXC_Msk     (_UINT8_(0x1) << SERCOM_USART_EXT_INTENCLR_RXC_Pos)  /* (SERCOM_USART_EXT_INTENCLR) Receive Complete Interrupt Enable Mask */
...
#define SERCOM_USART_EXT_INTENCLR_Msk         _UINT8_(0x0F)                                        /* (SERCOM_USART_EXT_INTENCLR) Register Mask  */
...
#define SERCOM_USART_INT_INTENCLR_DRE_Pos     _UINT8_(0)                                           /* (SERCOM_USART_INT_INTENCLR) Data Register Empty Interrupt Enable Position */
#define SERCOM_USART_INT_INTENCLR_DRE_Msk     (_UINT8_(0x1) << SERCOM_USART_INT_INTENCLR_DRE_Pos)  /* (SERCOM_USART_INT_INTENCLR) Data Register Empty Interrupt Enable Mask */
...
#define SERCOM_USART_INT_INTENCLR_TXC_Pos     _UINT8_(1)                                           /* (SERCOM_USART_INT_INTENCLR) Transmit Complete Interrupt Enable Position */
#define SERCOM_USART_INT_INTENCLR_TXC_Msk     (_UINT8_(0x1) << SERCOM_USART_INT_INTENCLR_TXC_Pos)  /* (SERCOM_USART_INT_INTENCLR) Transmit Complete Interrupt Enable Mask */
...
#define SERCOM_USART_INT_INTENCLR_RXC_Pos     _UINT8_(2)                                           /* (SERCOM_USART_INT_INTENCLR) Receive Complete Interrupt Enable Position */
#define SERCOM_USART_INT_INTENCLR_RXC_Msk     (_UINT8_(0x1) << SERCOM_USART_INT_INTENCLR_RXC_Pos)  /* (SERCOM_USART_INT_INTENCLR) Receive Complete Interrupt Enable Mask */
...
#define SERCOM_USART_INT_INTENCLR_Msk         _UINT8_(0x0F)                                        /* (SERCOM_USART_INT_INTENCLR) Register Mask  */
...
#define SERCOM_I2CM_INTENSET_Msk              _UINT8_(0x03)                                        /* (SERCOM_I2CM_INTENSET) Register Mask  */
...
#define SERCOM_I2CS_INTENSET_Msk              _UINT8_(0x07)                                        /* (SERCOM_I2CS_INTENSET) Register Mask  */
...
#define SERCOM_SPIM_INTENSET_Msk              _UINT8_(0x07)                                        /* (SERCOM_SPIM_INTENSET) Register Mask  */
...
#define SERCOM_SPIS_INTENSET_Msk              _UINT8_(0x07)                                        /* (SERCOM_SPIS_INTENSET) Register Mask  */
...
#define SERCOM_USART_EXT_INTENSET_Msk         _UINT8_(0x0F)                                        /* (SERCOM_USART_EXT_INTENSET) Register Mask  */
...
#define SERCOM_USART_INT_INTENSET_Msk         _UINT8_(0x0F)                                        /* (SERCOM_USART_INT_INTENSET) Register Mask  */
...
#define SERCOM_I2CM_INTFLAG_MB_Pos            _UINT8_(0)                                           /* (SERCOM_I2CM_INTFLAG) Master on Bus Position */
#define SERCOM_I2CM_INTFLAG_MB_Msk            (_UINT8_(0x1) << SERCOM_I2CM_INTFLAG_MB_Pos)         /* (SERCOM_I2CM_INTFLAG) Master on Bus Mask */
...
#define SERCOM_I2CM_INTFLAG_SB_Pos            _UINT8_(1)                                           /* (SERCOM_I2CM_INTFLAG) Slave on Bus Position */
#define SERCOM_I2CM_INTFLAG_SB_Msk            (_UINT8_(0x1) << SERCOM_I2CM_INTFLAG_SB_Pos)         /* (SERCOM_I2CM_INTFLAG) Slave on Bus Mask */
...
#define SERCOM_I2CM_INTFLAG_Msk               _UINT8_(0x03)                                        /* (SERCOM_I2CM_INTFLAG) Register Mask  */
...
#define SERCOM_I2CS_INTFLAG_Msk               _UINT8_(0x07)                                        /* (SERCOM_I2CS_INTFLAG) Register Mask  */
...
#define SERCOM_SPIM_INTFLAG_DRE_Pos           _UINT8_(0)                                           /* (SERCOM_SPIM_INTFLAG) Data Register Empty Position */
#define SERCOM_SPIM_INTFLAG_DRE_Msk           (_UINT8_(0x1) << SERCOM_SPIM_INTFLAG_DRE_Pos)        /* (SERCOM_SPIM_INTFLAG) Data Register Empty Mask */
...
#define SERCOM_SPIM_INTFLAG_TXC_Pos           _UINT8_(1)                                           /* (SERCOM_SPIM_INTFLAG) Transmit Complete Position */
#define SERCOM_SPIM_INTFLAG_TXC_Msk           (_UINT8_(0x1) << SERCOM_SPIM_INTFLAG_TXC_Pos)        /* (SERCOM_SPIM_INTFLAG) Transmit Complete Mask */
...
#define SERCOM_SPIM_INTFLAG_RXC_Pos           _UINT8_(2)                                           /* (SERCOM_SPIM_INTFLAG) Receive Complete Position */
#define SERCOM_SPIM_INTFLAG_RXC_Msk           (_UINT8_(0x1) << SERCOM_SPIM_INTFLAG_RXC_Pos)        /* (SERCOM_SPIM_INTFLAG) Receive Complete Mask */
...
#define SERCOM_SPIM_INTFLAG_Msk               _UINT8_(0x07)                                        /* (SERCOM_SPIM_INTFLAG) Register Mask  */
...
#define SERCOM_SPIS_INTFLAG_DRE_Pos           _UINT8_(0)                                           /* (SERCOM_SPIS_INTFLAG) Data Register Empty Position */
#define SERCOM_SPIS_INTFLAG_DRE_Msk           (_UINT8_(0x1) << SERCOM_SPIS_INTFLAG_DRE_Pos)        /* (SERCOM_SPIS_INTFLAG) Data Register Empty Mask */
...
#define SERCOM_SPIS_INTFLAG_TXC_Pos           _UINT8_(1)                                           /* (SERCOM_SPIS_INTFLAG) Transmit Complete Position */
#define SERCOM_SPIS_INTFLAG_TXC_Msk           (_UINT8_(0x1) << SERCOM_SPIS_INTFLAG_TXC_Pos)        /* (SERCOM_SPIS_INTFLAG) Transmit Complete Mask */
...
#define SERCOM_SPIS_INTFLAG_RXC_Pos           _UINT8_(2)                                           /* (SERCOM_SPIS_INTFLAG) Receive Complete Position */
#define SERCOM_SPIS_INTFLAG_RXC_Msk           (_UINT8_(0x1) << SERCOM_SPIS_INTFLAG_RXC_Pos)        /* (SERCOM_SPIS_INTFLAG) Receive Complete Mask */
...
#define SERCOM_SPIS_INTFLAG_Msk               _UINT8_(0x07)                                        /* (SERCOM_SPIS_INTFLAG) Register Mask  */
...
#define SERCOM_USART_EXT_INTFLAG_DRE_Pos      _UINT8_(0)                                           /* (SERCOM_USART_EXT_INTFLAG) Data Register Empty Position */
#define SERCOM_USART_EXT_INTFLAG_DRE_Msk      (_UINT8_(0x1) << SERCOM_USART_EXT_INTFLAG_DRE_Pos)   /* (SERCOM_USART_EXT_INTFLAG) Data Register Empty Mask */
...
#define SERCOM_USART_EXT_INTFLAG_TXC_Pos      _UINT8_(1)                                           /* (SERCOM_USART_EXT_INTFLAG) Transmit Complete Position */
#define SERCOM_USART_EXT_INTFLAG_TXC_Msk      (_UINT8_(0x1) << SERCOM_USART_EXT_INTFLAG_TXC_Pos)   /* (SERCOM_USART_EXT_INTFLAG) Transmit Complete Mask */
...
#define SERCOM_USART_EXT_INTFLAG_RXC_Pos      _UINT8_(2)                                           /* (SERCOM_USART_EXT_INTFLAG) Receive Complete Position */
#define SERCOM_USART_EXT_INTFLAG_RXC_Msk      (_UINT8_(0x1) << SERCOM_USART_EXT_INTFLAG_RXC_Pos)   /* (SERCOM_USART_EXT_INTFLAG) Receive Complete Mask */
...
#define SERCOM_USART_EXT_INTFLAG_Msk          _UINT8_(0x0F)                                        /* (SERCOM_USART_EXT_INTFLAG) Register Mask  */
...
#define SERCOM_USART_INT_INTFLAG_DRE_Pos      _UINT8_(0)                                           /* (SERCOM_USART_INT_INTFLAG) Data Register Empty Position */
#define SERCOM_USART_INT_INTFLAG_DRE_Msk      (_UINT8_(0x1) << SERCOM_USART_INT_INTFLAG_DRE_Pos)   /* (SERCOM_USART_INT_INTFLAG) Data Register Empty Mask */
...
#define SERCOM_USART_INT_INTFLAG_TXC_Pos      _UINT8_(1)                                           /* (SERCOM_USART_INT_INTFLAG) Transmit Complete Position */
#define SERCOM_USART_INT_INTFLAG_TXC_Msk      (_UINT8_(0x1) << SERCOM_USART_INT_INTFLAG_TXC_Pos)   /* (SERCOM_USART_INT_INTFLAG) Transmit Complete Mask */
...
#define SERCOM_USART_INT_INTFLAG_RXC_Pos      _UINT8_(2)                                           /* (SERCOM_USART_INT_INTFLAG) Receive Complete Position */
#define SERCOM_USART_INT_INTFLAG_RXC_Msk      (_UINT8_(0x1) << SERCOM_USART_INT_INTFLAG_RXC_Pos)   /* (SERCOM_USART_INT_INTFLAG) Receive Complete Mask */
...
#define SERCOM_USART_INT_INTFLAG_Msk          _UINT8_(0x0F)                                        /* (SERCOM_USART_INT_INTFLAG) Register Mask  */
...
#define SERCOM_I2CM_STATUS_SYNCBUSY_Pos       _UINT16_(15)                                         /* (SERCOM_I2CM_STATUS) Synchronization Busy Position */
#define SERCOM_I2CM_STATUS_SYNCBUSY_Msk       (_UINT16_(0x1) << SERCOM_I2CM_STATUS_SYNCBUSY_Pos)   /* (SERCOM_I2CM_STATUS) Synchronization Busy Mask */
#define SERCOM_I2CM_STATUS_SYNCBUSY(value)    (SERCOM_I2CM_STATUS_SYNCBUSY_Msk & (_UINT16_(value) << SERCOM_I2CM_STATUS_SYNCBUSY_Pos)) /* Assignment of value for SYNCBUSY in the SERCOM_I2CM_STATUS register */
#define SERCOM_I2CM_STATUS_Msk                _UINT16_(0x80F7)                                     /* (SERCOM_I2CM_STATUS) Register Mask  */
...
#define SERCOM_I2CS_STATUS_SYNCBUSY_Pos       _UINT16_(15)                                         /* (SERCOM_I2CS_STATUS) Synchronization Busy Position */
#define SERCOM_I2CS_STATUS_SYNCBUSY_Msk       (_UINT16_(0x1) << SERCOM_I2CS_STATUS_SYNCBUSY_Pos)   /* (SERCOM_I2CS_STATUS) Synchronization Busy Mask */
#define SERCOM_I2CS_STATUS_SYNCBUSY(value)    (SERCOM_I2CS_STATUS_SYNCBUSY_Msk & (_UINT16_(value) << SERCOM_I2CS_STATUS_SYNCBUSY_Pos)) /* Assignment of value for SYNCBUSY in the SERCOM_I2CS_STATUS register */
#define SERCOM_I2CS_STATUS_Msk                _UINT16_(0x80DF)                                     /* (SERCOM_I2CS_STATUS) Register Mask  */
...
#define SERCOM_SPIM_STATUS_SYNCBUSY_Pos       _UINT16_(15)                                         /* (SERCOM_SPIM_STATUS) Synchronization Busy Position */
#define SERCOM_SPIM_STATUS_SYNCBUSY_Msk       (_UINT16_(0x1) << SERCOM_SPIM_STATUS_SYNCBUSY_Pos)   /* (SERCOM_SPIM_STATUS) Synchronization Busy Mask */
#define SERCOM_SPIM_STATUS_SYNCBUSY(value)    (SERCOM_SPIM_STATUS_SYNCBUSY_Msk & (_UINT16_(value) << SERCOM_SPIM_STATUS_SYNCBUSY_Pos)) /* Assignment of value for SYNCBUSY in the SERCOM_SPIM_STATUS register */
#define SERCOM_SPIM_STATUS_Msk                _UINT16_(0x8004)                                     /* (SERCOM_SPIM_STATUS) Register Mask  */
...
#define SERCOM_SPIS_STATUS_SYNCBUSY_Pos       _UINT16_(15)                                         /* (SERCOM_SPIS_STATUS) Synchronization Busy Position */
#define SERCOM_SPIS_STATUS_SYNCBUSY_Msk       (_UINT16_(0x1) << SERCOM_SPIS_STATUS_SYNCBUSY_Pos)   /* (SERCOM_SPIS_STATUS) Synchronization Busy Mask */
#define SERCOM_SPIS_STATUS_SYNCBUSY(value)    (SERCOM_SPIS_STATUS_SYNCBUSY_Msk & (_UINT16_(value) << SERCOM_SPIS_STATUS_SYNCBUSY_Pos)) /* Assignment of value for SYNCBUSY in the SERCOM_SPIS_STATUS register */
#define SERCOM_SPIS_STATUS_Msk                _UINT16_(0x8004)                                     /* (SERCOM_SPIS_STATUS) Register Mask  */
...
#define SERCOM_USART_EXT_STATUS_SYNCBUSY_Pos  _UINT16_(15)                                         /* (SERCOM_USART_EXT_STATUS) Synchronization Busy Position */
#define SERCOM_USART_EXT_STATUS_SYNCBUSY_Msk  (_UINT16_(0x1) << SERCOM_USART_EXT_STATUS_SYNCBUSY_Pos) /* (SERCOM_USART_EXT_STATUS) Synchronization Busy Mask */
#define SERCOM_USART_EXT_STATUS_SYNCBUSY(value) (SERCOM_USART_EXT_STATUS_SYNCBUSY_Msk & (_UINT16_(value) << SERCOM_USART_EXT_STATUS_SYNCBUSY_Pos)) /* Assignment of value for SYNCBUSY in the SERCOM_USART_EXT_STATUS register */
#define SERCOM_USART_EXT_STATUS_Msk           _UINT16_(0x8007)                                     /* (SERCOM_USART_EXT_STATUS) Register Mask  */
...
#define SERCOM_USART_INT_STATUS_SYNCBUSY_Pos  _UINT16_(15)                                         /* (SERCOM_USART_INT_STATUS) Synchronization Busy Position */
#define SERCOM_USART_INT_STATUS_SYNCBUSY_Msk  (_UINT16_(0x1) << SERCOM_USART_INT_STATUS_SYNCBUSY_Pos) /* (SERCOM_USART_INT_STATUS) Synchronization Busy Mask */
#define SERCOM_USART_INT_STATUS_SYNCBUSY(value) (SERCOM_USART_INT_STATUS_SYNCBUSY_Msk & (_UINT16_(value) << SERCOM_USART_INT_STATUS_SYNCBUSY_Pos)) /* Assignment of value for SYNCBUSY in the SERCOM_USART_INT_STATUS register */
#define SERCOM_USART_INT_STATUS_Msk           _UINT16_(0x8007)                                     /* (SERCOM_USART_INT_STATUS) Register Mask  */


/* -------- SERCOM_I2CM_ADDR : (SERCOM Offset: 0x14) (R/W 8) I2CM Address -------- */
#define SERCOM_I2CM_ADDR_RESETVALUE           _UINT8_(0x00)                                        /*  (SERCOM_I2CM_ADDR) I2CM Address  Reset Value */

#define SERCOM_I2CM_ADDR_ADDR_Pos             _UINT8_(0)                                           /* (SERCOM_I2CM_ADDR) Address Position */
#define SERCOM_I2CM_ADDR_ADDR_Msk             (_UINT8_(0xFF) << SERCOM_I2CM_ADDR_ADDR_Pos)         /* (SERCOM_I2CM_ADDR) Address Mask */
#define SERCOM_I2CM_ADDR_ADDR(value)          (SERCOM_I2CM_ADDR_ADDR_Msk & (_UINT8_(value) << SERCOM_I2CM_ADDR_ADDR_Pos)) /* Assignment of value for ADDR in the SERCOM_I2CM_ADDR register */
#define SERCOM_I2CM_ADDR_Msk                  _UINT8_(0xFF)                                        /* (SERCOM_I2CM_ADDR) Register Mask  */
...
#define SERCOM_SPIM_ADDR_ADDR_Pos             _UINT32_(0)                                          /* (SERCOM_SPIM_ADDR) Address Position */
#define SERCOM_SPIM_ADDR_ADDR_Msk             (_UINT32_(0xFF) << SERCOM_SPIM_ADDR_ADDR_Pos)        /* (SERCOM_SPIM_ADDR) Address Mask */
...
#define SERCOM_SPIS_ADDR_ADDR_Pos             _UINT32_(0)                                          /* (SERCOM_SPIS_ADDR) Address Position */
#define SERCOM_SPIS_ADDR_ADDR_Msk             (_UINT32_(0xFF) << SERCOM_SPIS_ADDR_ADDR_Pos)        /* (SERCOM_SPIS_ADDR) Address Mask */
...
#define SERCOM_SPIM_DATA_RESETVALUE           _UINT16_(0x00)                                       /*  (SERCOM_SPIM_DATA) SPIM Data  Reset Value */

#define SERCOM_SPIM_DATA_DATA_Pos             _UINT16_(0)                                          /* (SERCOM_SPIM_DATA) Data Position */
#define SERCOM_SPIM_DATA_DATA_Msk             (_UINT16_(0x1FF) << SERCOM_SPIM_DATA_DATA_Pos)       /* (SERCOM_SPIM_DATA) Data Mask */
#define SERCOM_SPIM_DATA_DATA(value)          (SERCOM_SPIM_DATA_DATA_Msk & (_UINT16_(value) << SERCOM_SPIM_DATA_DATA_Pos)) /* Assignment of value for DATA in the SERCOM_SPIM_DATA register */
#define SERCOM_SPIM_DATA_Msk                  _UINT16_(0x01FF)                                     /* (SERCOM_SPIM_DATA) Register Mask  */


/* -------- SERCOM_SPIS_DATA : (SERCOM Offset: 0x18) (R/W 16) SPIS Data -------- */
#define SERCOM_SPIS_DATA_RESETVALUE           _UINT16_(0x00)                                       /*  (SERCOM_SPIS_DATA) SPIS Data  Reset Value */

#define SERCOM_SPIS_DATA_DATA_Pos             _UINT16_(0)                                          /* (SERCOM_SPIS_DATA) Data Value Position */
#define SERCOM_SPIS_DATA_DATA_Msk             (_UINT16_(0x1FF) << SERCOM_SPIS_DATA_DATA_Pos)       /* (SERCOM_SPIS_DATA) Data Value Mask */
#define SERCOM_SPIS_DATA_DATA(value)          (SERCOM_SPIS_DATA_DATA_Msk & (_UINT16_(value) << SERCOM_SPIS_DATA_DATA_Pos)) /* Assignment of value for DATA in the SERCOM_SPIS_DATA register */
#define SERCOM_SPIS_DATA_Msk                  _UINT16_(0x01FF)                                     /* (SERCOM_SPIS_DATA) Register Mask  */
...
#define SERCOM_USART_EXT_DATA_DATA_Pos        _UINT16_(0)                                          /* (SERCOM_USART_EXT_DATA) Data Position */
#define SERCOM_USART_EXT_DATA_DATA_Msk        (_UINT16_(0x1FF) << SERCOM_USART_EXT_DATA_DATA_Pos)  /* (SERCOM_USART_EXT_DATA) Data Mask */
...
#define SERCOM_USART_INT_DATA_DATA_Pos        _UINT16_(0)                                          /* (SERCOM_USART_INT_DATA) Data Position */
#define SERCOM_USART_INT_DATA_DATA_Msk        (_UINT16_(0x1FF) << SERCOM_USART_INT_DATA_DATA_Pos)  /* (SERCOM_USART_INT_DATA) Data Mask */
...
#define SERCOM_I2CM_DBGCTRL_REG_OFST   _UINT32_(0x08)      /* (SERCOM_I2CM_DBGCTRL) I2CM Debug Control Offset */
#define SERCOM_SPIM_DBGCTRL_REG_OFST   _UINT32_(0x08)      /* (SERCOM_SPIM_DBGCTRL) SPIM Debug Control Offset */
#define SERCOM_SPIS_DBGCTRL_REG_OFST   _UINT32_(0x08)      /* (SERCOM_SPIS_DBGCTRL) SPIS Debug Control Offset */
#define SERCOM_USART_EXT_DBGCTRL_REG_OFST _UINT32_(0x08)      /* (SERCOM_USART_EXT_DBGCTRL) USART_EXT Debug Control Offset */
#define SERCOM_USART_INT_DBGCTRL_REG_OFST _UINT32_(0x08)      /* (SERCOM_USART_INT_DBGCTRL) USART_INT Debug Control Offset */
#define SERCOM_I2CM_BAUD_REG_OFST      _UINT32_(0x0A)      /* (SERCOM_I2CM_BAUD) I2CM Baud Rate Offset */
#define SERCOM_SPIM_BAUD_REG_OFST      _UINT32_(0x0A)      /* (SERCOM_SPIM_BAUD) SPIM Baud Rate Offset */
#define SERCOM_SPIS_BAUD_REG_OFST      _UINT32_(0x0A)      /* (SERCOM_SPIS_BAUD) SPIS Baud Rate Offset */
#define SERCOM_USART_EXT_BAUD_REG_OFST _UINT32_(0x0A)      /* (SERCOM_USART_EXT_BAUD) USART_EXT Baud Offset */
#define SERCOM_USART_INT_BAUD_REG_OFST _UINT32_(0x0A)      /* (SERCOM_USART_INT_BAUD) USART_INT Baud Offset */
#define SERCOM_I2CM_INTENCLR_REG_OFST  _UINT32_(0x0C)      /* (SERCOM_I2CM_INTENCLR) I2CM Interrupt Enable Clear Offset */
#define SERCOM_I2CS_INTENCLR_REG_OFST  _UINT32_(0x0C)      /* (SERCOM_I2CS_INTENCLR) I2CS Interrupt Enable Clear Offset */
#define SERCOM_SPIM_INTENCLR_REG_OFST  _UINT32_(0x0C)      /* (SERCOM_SPIM_INTENCLR) SPIM Interrupt Enable Clear Offset */
#define SERCOM_SPIS_INTENCLR_REG_OFST  _UINT32_(0x0C)      /* (SERCOM_SPIS_INTENCLR) SPIS Interrupt Enable Clear Offset */
#define SERCOM_USART_EXT_INTENCLR_REG_OFST _UINT32_(0x0C)      /* (SERCOM_USART_EXT_INTENCLR) USART_EXT Interrupt Enable Clear Offset */
#define SERCOM_USART_INT_INTENCLR_REG_OFST _UINT32_(0x0C)      /* (SERCOM_USART_INT_INTENCLR) USART_INT Interrupt Enable Clear Offset */
#define SERCOM_I2CM_INTENSET_REG_OFST  _UINT32_(0x0D)      /* (SERCOM_I2CM_INTENSET) I2CM Interrupt Enable Set Offset */
#define SERCOM_I2CS_INTENSET_REG_OFST  _UINT32_(0x0D)      /* (SERCOM_I2CS_INTENSET) I2CS Interrupt Enable Set Offset */
#define SERCOM_SPIM_INTENSET_REG_OFST  _UINT32_(0x0D)      /* (SERCOM_SPIM_INTENSET) SPIM Interrupt Enable Set Offset */
#define SERCOM_SPIS_INTENSET_REG_OFST  _UINT32_(0x0D)      /* (SERCOM_SPIS_INTENSET) SPIS Interrupt Enable Set Offset */
#define SERCOM_USART_EXT_INTENSET_REG_OFST _UINT32_(0x0D)      /* (SERCOM_USART_EXT_INTENSET) USART_EXT Interrupt Enable Set Offset */
#define SERCOM_USART_INT_INTENSET_REG_OFST _UINT32_(0x0D)      /* (SERCOM_USART_INT_INTENSET) USART_INT Interrupt Enable Set Offset */
#define SERCOM_I2CM_INTFLAG_REG_OFST   _UINT32_(0x0E)      /* (SERCOM_I2CM_INTFLAG) I2CM Interrupt Flag Status and Clear Offset */
#define SERCOM_I2CS_INTFLAG_REG_OFST   _UINT32_(0x0E)      /* (SERCOM_I2CS_INTFLAG) I2CS Interrupt Flag Status and Clear Offset */
#define SERCOM_SPIM_INTFLAG_REG_OFST   _UINT32_(0x0E)      /* (SERCOM_SPIM_INTFLAG) SPIM Interrupt Flag Status and Clear Offset */
#define SERCOM_SPIS_INTFLAG_REG_OFST   _UINT32_(0x0E)      /* (SERCOM_SPIS_INTFLAG) SPIS Interrupt Flag Status and Clear Offset */
#define SERCOM_USART_EXT_INTFLAG_REG_OFST _UINT32_(0x0E)      /* (SERCOM_USART_EXT_INTFLAG) USART_EXT Interrupt Flag Status and Clear Offset */
#define SERCOM_USART_INT_INTFLAG_REG_OFST _UINT32_(0x0E)      /* (SERCOM_USART_INT_INTFLAG) USART_INT Interrupt Flag Status and Clear Offset */
#define SERCOM_I2CM_STATUS_REG_OFST    _UINT32_(0x10)      /* (SERCOM_I2CM_STATUS) I2CM Status Offset */
#define SERCOM_I2CS_STATUS_REG_OFST    _UINT32_(0x10)      /* (SERCOM_I2CS_STATUS) I2CS Status Offset */
#define SERCOM_SPIM_STATUS_REG_OFST    _UINT32_(0x10)      /* (SERCOM_SPIM_STATUS) SPIM Status Offset */
#define SERCOM_SPIS_STATUS_REG_OFST    _UINT32_(0x10)      /* (SERCOM_SPIS_STATUS) SPIS Status Offset */
#define SERCOM_USART_EXT_STATUS_REG_OFST _UINT32_(0x10)      /* (SERCOM_USART_EXT_STATUS) USART_EXT Status Offset */
#define SERCOM_USART_INT_STATUS_REG_OFST _UINT32_(0x10)      /* (SERCOM_USART_INT_STATUS) USART_INT Status Offset */
#define SERCOM_I2CM_ADDR_REG_OFST      _UINT32_(0x14)      /* (SERCOM_I2CM_ADDR) I2CM Address Offset */
#define SERCOM_I2CS_ADDR_REG_OFST      _UINT32_(0x14)      /* (SERCOM_I2CS_ADDR) I2CS Address Offset */
#define SERCOM_SPIM_ADDR_REG_OFST      _UINT32_(0x14)      /* (SERCOM_SPIM_ADDR) SPIM Address Offset */
#define SERCOM_SPIS_ADDR_REG_OFST      _UINT32_(0x14)      /* (SERCOM_SPIS_ADDR) SPIS Address Offset */
#define SERCOM_I2CM_DATA_REG_OFST      _UINT32_(0x18)      /* (SERCOM_I2CM_DATA) I2CM Data Offset */
#define SERCOM_I2CS_DATA_REG_OFST      _UINT32_(0x18)      /* (SERCOM_I2CS_DATA) I2CS Data Offset */
#define SERCOM_SPIM_DATA_REG_OFST      _UINT32_(0x18)      /* (SERCOM_SPIM_DATA) SPIM Data Offset */
#define SERCOM_SPIS_DATA_REG_OFST      _UINT32_(0x18)      /* (SERCOM_SPIS_DATA) SPIS Data Offset */
#define SERCOM_USART_EXT_DATA_REG_OFST _UINT32_(0x18)      /* (SERCOM_USART_EXT_DATA) USART_EXT Data Offset */
#define SERCOM_USART_INT_DATA_REG_OFST _UINT32_(0x18)      /* (SERCOM_USART_INT_DATA) USART_INT Data Offset */
...
#endif /* _PIC32CMGV00_SERCOM_COMPONENT_H_ */
