...
#ifndef _PIC32CMGV00_PM_COMPONENT_H_
#define _PIC32CMGV00_PM_COMPONENT_H_
...
#define PM_AHBMASK_RESETVALUE                 _UINT32_(0x1F)                                       /*  (PM_AHBMASK) AHB Mask  Reset Value */
...
#define PM_AHBMASK_Msk                        _UINT32_(0x0000001F)                                 /* (PM_AHBMASK) Register Mask  */
...
#define PM_APBBMASK_RESETVALUE                _UINT32_(0x1F)                                       /*  (PM_APBBMASK) APBB Mask  Reset Value */
...
#define PM_APBBMASK_Msk                       _UINT32_(0x0000000F)                                 /* (PM_APBBMASK) Register Mask  */
...
#define PM_APBCMASK_TC0_Pos                   _UINT32_(8)                                          /* (PM_APBCMASK) TC0 APB Clock Enable Position */
#define PM_APBCMASK_TC0_Msk                   (_UINT32_(0x1) << PM_APBCMASK_TC0_Pos)               /* (PM_APBCMASK) TC0 APB Clock Enable Mask */
#define PM_APBCMASK_TC0(value)                (PM_APBCMASK_TC0_Msk & (_UINT32_(value) << PM_APBCMASK_TC0_Pos)) /* Assignment of value for TC0 in the PM_APBCMASK register */
#define PM_APBCMASK_TC1_Pos                   _UINT32_(9)                                          /* (PM_APBCMASK) TC1 APB Clock Enable Position */
#define PM_APBCMASK_TC1_Msk                   (_UINT32_(0x1) << PM_APBCMASK_TC1_Pos)               /* (PM_APBCMASK) TC1 APB Clock Enable Mask */
#define PM_APBCMASK_TC1(value)                (PM_APBCMASK_TC1_Msk & (_UINT32_(value) << PM_APBCMASK_TC1_Pos)) /* Assignment of value for TC1 in the PM_APBCMASK register */
#define PM_APBCMASK_TC2_Pos                   _UINT32_(10)                                         /* (PM_APBCMASK) TC2 APB Clock Enable Position */
#define PM_APBCMASK_TC2_Msk                   (_UINT32_(0x1) << PM_APBCMASK_TC2_Pos)               /* (PM_APBCMASK) TC2 APB Clock Enable Mask */
#define PM_APBCMASK_TC2(value)                (PM_APBCMASK_TC2_Msk & (_UINT32_(value) << PM_APBCMASK_TC2_Pos)) /* Assignment of value for TC2 in the PM_APBCMASK register */
...
#define PM_APBCMASK_TC_Pos                    _UINT32_(8)                                          /* (PM_APBCMASK Position) TCx APB Clock Enable */
#define PM_APBCMASK_TC_Msk                    (_UINT32_(0xFF) << PM_APBCMASK_TC_Pos)               /* (PM_APBCMASK Mask) TC */
...
#endif /* _PIC32CMGV00_PM_COMPONENT_H_ */
