...
#ifndef _PIC32CMGV00_DAC_COMPONENT_H_
#define _PIC32CMGV00_DAC_COMPONENT_H_
...
#define DAC_CTRLB_Msk                         _UINT8_(0xCF)                                        /* (DAC_CTRLB) Register Mask  */
...
#define DAC_DATA_DATA_Pos                     _UINT16_(0)                                          /* (DAC_DATA) Data to be converted Position */
#define DAC_DATA_DATA_Msk                     (_UINT16_(0xFFFF) << DAC_DATA_DATA_Pos)              /* (DAC_DATA) Data to be converted Mask */
...
#endif /* _PIC32CMGV00_DAC_COMPONENT_H_ */
